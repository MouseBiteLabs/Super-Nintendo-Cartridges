...
# **Order at your own risk -- v1.2 is untested, but likely works (v1.1 tests are complete)**
...
<a href="https://www.pcbway.com/project/shareproject/Super_Nintendo_Advanced_Flash_Cartridge_LoROM_ed4ed270.html"><img src="https://www.pcbway.com/project/img/images/frompcbway-1220.png" alt="PCB from PCBWay" /></a>
...
- You need a way to program the ROM chip(s).
  ...
  - Another option is to use insideGadgets' <a href="https://shop.insidegadgets.com/product/snesxflasher/">SNES programmer</a> made specifically for my cartridges. <a href="https://shop.insidegadgets.com/product/snes-advanced-flash-cartridge/">You can even purchase assembled boards from them!</a>
...
- **Every board needs Group A components.** You can make LoRom games that have no RAM and are up to 4 MB large with this configuration. (If your game is only 2 MB, you do not need to include U9 and C9)
...
https://www.mouser.com/ProjectManager/ProjectDetail.aspx?AccessID=b7de252bab
